...
export const login = (email, password) => async (dispatch) => {
	try {
		...
		const { data } = await http.post('/api/users/login', { email, password }, config);
		dispatch({
...
export const register = (name, email, password) => async (dispatch) => {
	try {
		...
		const { data } = await http.post('/api/users', { name, email, password }, config);
		dispatch({
...
export const deleteUser = (userId) => async (dispatch, getState) => {
	try {
		...
		await http.delete(`/api/users/${userId}`, config);
